		...
		<div class="container">
			<div class="jumbotron text-center">
				...
				<?php foreach ($usersQuery as $user) : ?>
					...
					<?php echo '<td>'.pegarTurmaDoAluno($user->idUsuario).'</td>'; ?> 
					<?php echo "<td><a href='_editAluno.php?user=$user->idUsuario' class='btn btn-info btn-sm'><span class='glyphicon glyphicon-edit'></span> Editar</a></td>"; ?>
					<?php echo "<td><a href='_deleteAluno.php?user=$user->idUsuario' class='btn btn-danger btn-sm'><span class='glyphicon glyphicon-remove'></span> Deletar</a></a></td></tr>"; ?>
				<?php endforeach; ?>	
				</table>
