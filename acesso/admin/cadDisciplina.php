		...
		<div class="container">
			<div class="jumbotron text-center">
				...
				<?php foreach ($usersQuery as $user) : ?>
					<?php echo '<tr><td>'.$user->nomeDisciplina.'</td>'; ?> 
					<?php echo "<td><a href='_editDisciplina.php?disc=$user->idDisciplina' class='btn btn-info btn-sm'><span class='glyphicon glyphicon-edit'></span> Editar</a></td>"; ?> 
					<?php echo "<td><a href='_deleteDisciplina.php?disc=$user->idDisciplina' class='btn btn-danger btn-sm'><span class='glyphicon glyphicon-remove'></span> Deletar</a></td></tr>"; ?>
				<?php endforeach; ?>	
				</table>
