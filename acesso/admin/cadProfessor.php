		...
		<div class="container">
			<div class="jumbotron text-center">
				...
				<?php foreach ($usersQuery as $user) : ?>
					...
					<?php echo "<td><a href='_editProfessor.php?user=$user->idUsuario' class='btn btn-info btn-sm'><span class='glyphicon glyphicon-edit'></span> Editar</a></td>"; ?> 
					<?php echo "<td><a href='_deleteProfessor.php?user=$user->idUsuario' class='btn btn-danger btn-sm'><span class='glyphicon glyphicon-remove'></span> Deletar</a></td></tr></a> "; ?>
				<?php endforeach; ?>	
				</table>
				...
				<table style="margin-left: auto; margin-right: auto; font-size: 13;">
					<?php foreach ($profDiscQuery as $profDisc) : ?>
						<tr><td><?php echo pegarNomeProfessor($profDisc->idProfessor); ?></td>
						<td><?php echo pegarDisciplina($profDisc->idDisciplina); ?></td>
						<td><?php echo pegarTurma($profDisc->idTurma); ?></td>
						<td><?php echo"<a href='_deleteDisciplinaPorProfessor.php?disc=$profDisc->idDisciplinaPorProfessor' class='btn btn-danger btn-sm'><span class='glyphicon glyphicon-remove'></span> Deletar</a> "; ?></td></tr>
					<?php endforeach; ?>
				</table>
