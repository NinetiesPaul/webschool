...
function pegarTurma($int){ //function parameters, two variables.
...
function pegarTurmaDoAluno($int){ //function parameters, two variables.
...
function pegarDisciplina($int){ //function parameters, two variables.
...
function pegaridProfessor($int){ //function parameters, two variables.
...
function pegarNomeProfessor($int){ //function parameters, two variables.
...
function pegarIdDoAluno($int){ //function parameters, two variables.
...
function pegarNotaDoAluno($aluno, $disciplina, $turma){ //function parameters, two variables.
...
function pegarFaltasDoAluno($aluno, $disciplina, $turma){ //function parameters, two variables.
...
function pegarFaltasDoAluno_($aluno, $disciplina, $turma){ //function parameters, two variables.
...
function pegarNomeDoAluno($int){ //function parameters, two variables.
...
function pegarNomeDoResponsavel($int){ //function parameters, two variables.
...
function pegarEstado($int){ //function parameters, two variables.
...
function verificarLogin($email){ //function parameters, two variables.
